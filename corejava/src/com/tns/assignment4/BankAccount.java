...
//		
	...
	public static void withdrawl() throws InsufficentAmountException{
		Scanner sc=new Scanner(System.in);
		...
		if(balance==0 || withdrawn==0 || withdrawn>100000) {
			throw new InsufficentAmountException("Withdrawl amount is not possible for this account number"+accountNumber);
		}
		balance-=withdrawn;
	}
	public void display() {
